...
class CommandFlow:
    ...
    def register_submitted(self, ack, body, client, view, say):
        ...
        say(channel=user_slack_id, text="Your Slack account is now tied to the name " + matched_name + ". If you are an Assistant House Manager, you can now sign off jobs. You will also receieve a reminder at 6pm ET if you haven't completed your house job.")
